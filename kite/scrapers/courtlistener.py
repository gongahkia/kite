"""
CourtListener scraper for Kite library.
...
def fetch_recent_cases(
    ...
    Example:
        >>> from kite.courtlistener import fetch_recent_cases
...
def search_cases(
    ...
    Example:
        >>> from kite.courtlistener import search_cases
...
def get_case_by_id(case_id: str) -> Optional[CaseData]:
    ...
    Example:
        >>> from kite.courtlistener import get_case_by_id
